...
void processControl(){
	...
	// mkdir will create all parent directories, if they are missing
	std::string commandStart = "mkdir -p ";
	std::string commandFull = commandStart + watchDirectoryPath + "/.versions";
